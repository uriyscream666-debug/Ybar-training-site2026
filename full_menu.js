// full_menu.js – ПОЛНАЯ БАРНАЯ КАРТА (ВОССТАНОВЛЕННАЯ ВЕРСИЯ)
const BAR_MENU = [
    // ========== МИНЕРАЛЬНАЯ ВОДА ==========
    ...
    { id: 14, name: "Кока-Кола", volume: "0.25 л", price: 0, category: "soft_drinks", shortDesc: "Классическая газировка", fullDesc: "Coca-Cola.", story: "«Вечная классика — освежает в любую погоду».", tags: ["газировка"], allergens: [] },
    ...
    { id: 17, name: "Тоник классический", volume: "0.25 л", price: 0, category: "tonic", shortDesc: "Хинный тоник", fullDesc: "Индиан тоник.", story: "«Идеально к джину».", tags: ["тоник"], allergens: [] },
    { id: 18, name: "Тоник имбирный", volume: "0.25 л", price: 0, category: "tonic", shortDesc: "Имбирный эль", fullDesc: "The Gardenist Имбирный эль.", story: "«Пикантный, жгучий. Идеально к джину».", tags: ["тоник"], allergens: [] },
